package com.wx.voice.view.emptylayout;
...
public class FrameEmptyLayout extends FrameLayout {
    ...
    private void setLoadingView() {
        if(loadingView == null){
            loadingView = (LoadingView) inflater.inflate(R.layout.layout_emply_loading, this,false);
    ...
    private void setEmptyView(int resImgId, String txtTip) {
        if (emptyView == null) {
            ...
            emptyImageView = (ImageView) emptyView.findViewById(R.id.iv_empty_icon);
            emptyTextView = (TextView) emptyView.findViewById(R.id.tv_empty_text);
    ...
    private void setErrorView(int resImgId, String txtTip, String contentTip) {
        if (errorView == null) {
            ...
            errorImageView = (ImageView) errorView.findViewById(R.id.iv_error_icon);
            errorTextView = (TextView) errorView.findViewById(R.id.tv_error_text);
            errorRetry = (Button) errorView.findViewById(R.id.tv_error_retry);
