 ...
 */
public class LocalMediaPlayManager implements MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnErrorListener {
    ...
    private static class SingletonHolder {
        private static LocalMediaPlayManager instance = new LocalMediaPlayManager();
    }

    public static LocalMediaPlayManager getInstance() {
        return SingletonHolder.instance;
    }


    private LocalMediaPlayManager() {
    ...
    private void startPrepare(MusicEntity musicEntity) {
        try {
            mMediaPlayer.setDataSource(musicEntity.decoding_url);
