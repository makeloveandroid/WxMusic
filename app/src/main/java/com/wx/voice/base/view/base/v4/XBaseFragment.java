package com.wx.voice.base.view.base.v4;
...
import com.wx.voice.base.view.interfaces.XFragViewCycle;
...
public abstract class XBaseFragment<T extends XBasePresenter> extends Fragment implements XFragViewCycle {
     ...
     * 不要new 新的 NotePagerAdapter 而采取reset数据的方式
     ...
     *     use this when NotePagerAdapter need refresh multiple Fragment.
     *
     * </pre>
     */
